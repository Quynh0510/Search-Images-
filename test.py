...
class BOV:
    ...
    def trainModel(self):
        ...
        self.images, self.trainImageCount = self.file_helper.getFiles1(self.train_path)
        ...
        for word, imlist in self.images.items():
            ...
            label_count += 1
        self.bov_helper = pickle.load(open('model', 'rb'))
    ...
    def testModel(self):
        ...
        for word, imlist in self.testImages.items():
            ...
            for im in imlist:
                ...
                label.append(self.name_dict[str(int(cl[0]))])
        #print (predictions)
